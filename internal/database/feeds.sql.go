...
SELECT feeds.id, feeds.name, feeds.url, feeds.user_id, feeds.created_at, feeds.updated_at, users.name as user_name FROM feeds JOIN users ON feeds.user_id = users.id
`
